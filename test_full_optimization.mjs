// Self-contained script to test solveTSP with full 17 clients
...
// Full 17 Vespertina clients
const startCoords = { lat: 25.781917, lng: -100.191302 };
const stops = [
  { id: '1', name: "Juan Antonio Reyes", lat: 25.7129255394602, lng: -100.262037188781 },
  { id: '2', name: "Ivar Cach Junco", lat: 25.7044902477587, lng: -100.267557718395 },
  { id: '3', name: "Andrea Enciso Beltrán & Ricardo Mendoza Gómez", lat: 25.699956338662, lng: -100.345370457775 },
  { id: '4', name: "Jenny Adame Vargas y Johana Medina Gzz", lat: 25.7040542738813, lng: -100.349037928053 },
  { id: '5', name: "Lucía Francisca Delgado Gzz", lat: 25.7064977130287, lng: -100.350259006948 },
  { id: '6', name: "Jose Antonio Guillen", lat: 25.7024447009946, lng: -100.366585088906 },
  { id: '7', name: "Carlos Adrián Pérez Chavarria", lat: 25.6923650631083, lng: -100.361471486007 },
  { id: '8', name: "Paulina Aguilera Faz y Carlos Javier Elizondo", lat: 25.6672577761612, lng: -100.377165257385 },
  { id: '9', name: "Jacqueline Hay & Cynthia Garza", lat: 25.6566726951341, lng: -100.364799481602 },
  { id: '10', name: "Ricardo Terrazas", lat: 25.6525096119771, lng: -100.345543617346 },
  { id: '11', name: "Lizbeth Jiménez Contreras", lat: 25.6713371849846, lng: -100.325177611578 },
  { id: '12', name: "Marco Eduardo Rodríguez Gomez", lat: 25.6796255449219, lng: -100.315859011323 },
  { id: '13', name: "Marisbel Rosas Hdz", lat: 25.6863212037611, lng: -100.329701323564 },
  { id: '14', name: "Gabriel Macías Godoy", lat: 25.684969851881, lng: -100.334293739948 },
  { id: '15', name: "Jose Jaime Carrillo", lat: 25.6795710346822, lng: -100.395541214381 },
  { id: '16', name: "Ana Elia Guerra Escamilla", lat: 25.66040078916, lng: -100.437001786874 },
  { id: '17', name: "Cinthia González Regalado", lat: 25.7032059302575, lng: -100.447549927745 }
];

console.log("=== RUNNING FULL SOLVE_TSP ===");
